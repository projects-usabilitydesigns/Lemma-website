...
function buildContactRequestEmail(values) {
          ...
          <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:100%;max-width:600px;">
            ...
            <tr>
              <td style="background:#008fdb;padding:28px 32px;">
                ...
                <p style="margin:10px 0 0;color:#e8f6fd;font-size:15px;line-height:22px;">${escapeHtml(company)}${String(values.designation ?? "").trim() ? ` · ${escapeHtml(String(values.designation).trim())}` : ""} · ${escapeHtml(audienceLabel)}</p>
              </td>
            </tr>
            <tr>
...
module.exports = { buildContactRequestEmail };
