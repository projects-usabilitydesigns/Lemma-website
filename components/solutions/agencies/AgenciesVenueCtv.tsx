...
import { agenciesVenueCtv } from "@/lib/solutions-agencies-page-data";

export function AgenciesVenueCtv() {
  return (
            ...
            <div className="space-y-4">
              <div className="rounded-[16px] border border-[var(--color-border)] bg-[#f8f9fb] p-5 md:p-7">
                <div className="grid grid-cols-2 gap-5">
                  {agenciesVenueCtv.metrics.map((m) => (
              ...
              <div className="rounded-[16px] border border-[var(--color-border)] bg-white p-5 md:p-7">
                <div className="mb-4 flex items-center justify-between">
                  <p className="font-heading text-[16px] font-semibold text-[var(--color-ink)]">
                    {agenciesVenueCtv.chartTitle}
                  </p>
                  <div className="flex items-center gap-4">
                    {agenciesVenueCtv.chartSeries.map((s) => (
                ...
                <svg viewBox="0 0 600 240" className="w-full" preserveAspectRatio="none" role="img" aria-label={`${agenciesVenueCtv.chartTitle} chart`}>
                  <defs>
                    <linearGradient id="agenciesChartFill" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor="#1581c5" stopOpacity="0.25" />
                      <stop offset="100%" stopColor="#1581c5" stopOpacity="0" />
                    </linearGradient>
                  </defs>
                  <path d="M 0 180 C 80 170, 120 120, 200 110 S 320 80, 400 60 S 520 40, 600 30 L 600 240 L 0 240 Z" fill="url(#agenciesChartFill)" />
                  <path d="M 0 180 C 80 170, 120 120, 200 110 S 320 80, 400 60 S 520 40, 600 30" fill="none" stroke="#1581c5" strokeWidth="2.5" />
                  <path d="M 0 210 C 80 200, 130 170, 220 150 S 340 130, 430 100 S 540 70, 600 60" fill="none" stroke="#f82d89" strokeWidth="2.5" />
                </svg>
              </div>
            </div>
          </div>
