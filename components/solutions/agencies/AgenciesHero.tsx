...
import { agenciesHero, agenciesStats } from "@/lib/solutions-agencies-page-data";
      ...
      <Container className="relative flex h-full items-center pt-[120px] pb-10 md:pt-[130px] md:pb-0">
        <div className="grid w-full items-center gap-10 lg:grid-cols-[1fr_1fr] lg:gap-12">
          <div className="flex flex-col gap-6">
            <SectionLabel label={agenciesHero.label} />
            ...
            >
              <Button
                href={agenciesHero.primaryCta.href}
                variant="primary"
                arrow="right"
                className="normal-case tracking-normal px-7 py-3 text-[15px] font-semibold"
              >
                {agenciesHero.primaryCta.label}
              </Button>
              <Button
                href={agenciesHero.secondaryCta.href}
                variant="outline"
                arrow="none"
                className="normal-case tracking-normal px-7 py-3 text-[15px] font-semibold"
              >
                {agenciesHero.secondaryCta.label}
              </Button>
            </motion.div>
          ...
          >
            <Image
              src={agenciesHero.image}
              alt={agenciesHero.imageAlt}
              fill
