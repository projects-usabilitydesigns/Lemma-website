      ...
      <Container className="flex flex-col gap-16 md:gap-24">
        {phiFeatures.map((feature) => {
          ...
          return (
            ...
            >
              <div
                className="flex h-fit w-full max-w-[520px] flex-col gap-3 self-center rounded-[20px] px-8 py-10 md:px-10 md:py-12 lg:px-12 lg:py-14"
              ...
              >
                <div
                  className="pointer-events-none absolute left-1/2 top-1/2 z-0 aspect-square w-[88%] -translate-x-1/2 -translate-y-1/2 rounded-full"
                  style={{
