export const SUBSCRIBE_LOGO_CID = "lemma-logo";
...
export function buildSubscribeNotificationEmail(email: string, pageUrl: string) {
...
export function buildSubscribeAckEmail() {
